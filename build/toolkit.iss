...
Source: "{#SourceDir}\{#ReleaseDir}\H.NotifyIcon.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "{#SourceDir}\{#ReleaseDir}\Hardcodet.Wpf.TaskbarNotification.dll"; DestDir: "{app}"; Flags: ignoreversion
