...
namespace Dicom.Printing
{
    ...
    public static class FilmBoxExtensions
    {
        ...
        public static void DoPrint(this FilmBox filmBox, Graphics graphics, Rectangle marginBounds, int imageResolution)
        {
            ...
            if (parts.Length > 0)
            {
                ...
                {
                    filmBox.BasicImageBoxes[i].DoPrint(graphics, boxes[i], imageResolution);
                }
            }
        }
